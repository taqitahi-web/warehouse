...
/* ── _initFbSync compatibility stub ──
   Called by maintenance_log.html and other pages.
   Returns a resolved Promise so page init continues. */
window._initFbSync = function() {
